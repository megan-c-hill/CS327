...
extern char* itemDescriptionFile[368];

void initItemDescriptionFile() {
    const char* itemDescriptionInfo[368] = {
    ...
    int i;
    for(i = 0; i < 368; i++) {
        char* descriptionString = (char *)malloc(sizeof(itemDescriptionInfo));
        strcpy(descriptionString, itemDescriptionInfo[i]);
        itemDescriptionFile[i] = descriptionString;
    }
}
